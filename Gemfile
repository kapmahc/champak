...
gem 'spree_digital', github: 'spree-contrib/spree_digital', branch: '3-1-stable'
...
gem 'spree_active_shipping', github: 'spree-contrib/spree_active_shipping', branch: '3-1-stable'
