...
func (p *Engine) getUsersChangePassword(c *gin.Context) {
	...
	title := p.I18n.T(lng, "auth.personal.change-password.title")
...
func (p *Engine) postUsersChangePassword(c *gin.Context, o interface{}) error {
	...
	ss.Save()
	c.Redirect(http.StatusFound, "/personal/change-password")
	return nil
}
...
func (p *Engine) getUsersLogs(c *gin.Context) {
	...
	data["title"] = p.I18n.T(lng, "auth.personal.logs.title")
	data["logs"] = user.Logs
...
func (p *Engine) postUsersProfile(c *gin.Context, o interface{}) error {
	...
	c.Redirect(http.StatusFound, "/personal/profile")
	return nil
}
